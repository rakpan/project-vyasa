...
MEMORY_URL=http://vyasa-memory:8529           # Memory (ArangoDB) - Knowledge Graph
MEMORY_SERVICE_URL=http://vyasa-memory:8529   # Alias
ARANGODB_URL=http://vyasa-memory:8529        # Alias
