# Project Vyasa Console

This directory contains the Next.js frontend application for Project Vyasa.
...
- `QDRANT_URL`: Qdrant vector database URL (default: http://vyasa-qdrant:6333)
